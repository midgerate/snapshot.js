...
var walletFollowTypes = {
    Follow: [
        { name: 'from', type: 'address' },
        { name: 'wallet', type: 'string' }
    ]
};
var walletUnfollowTypes = {
    Unfollow: [
        { name: 'from', type: 'address' },
        { name: 'wallet', type: 'string' }
    ]
...
var Client = /** @class */ (function () {
    ...
    Client.prototype.walletFollow = function (web3, address, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sign(web3, address, message, walletFollowTypes)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Client.prototype.walletUnfollow = function (web3, address, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sign(web3, address, message, walletUnfollowTypes)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
