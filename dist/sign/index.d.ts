...
import { Space, Proposal, CancelProposal, Vote, Follow, Unfollow, WalletFollow, WalletUnfollow, Subscribe, Unsubscribe, Alias } from './types';
...
export default class Client {
    ...
    walletFollow(web3: Web3Provider | Wallet, address: string, message: WalletFollow): Promise<unknown>;
    walletUnfollow(web3: Web3Provider | Wallet, address: string, message: WalletUnfollow): Promise<unknown>;
